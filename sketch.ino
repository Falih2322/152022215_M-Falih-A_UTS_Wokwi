...
void setup() {
  ...
  dhtSensor.setup(DHTPIN, DHTesp::DHT22); // Gunakan DHT22
...
void loop() {
  ...
  if (!isnan(temperature) && !isnan(humidity)) {
    ...
    mqtt.publish("152022215_M Falih A_UTS", payload);

    Serial.print("Data sent to MQTT: ");
    Serial.println(payload);
  }

  // Kurangi delay untuk respon yang lebih cepat
  delay(1000); // Delay 1 detik agar pembacaan lebih sering
}
